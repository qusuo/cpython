...
// iOS: file zmq.h from libzmq distribution, 
// heavily edited so it can be parsed by ffi.cdef
// Goal: avoid having a #define that depends on a #define
...
// Not the parsing error, but not working nevertheless
...
#define ZMQ_EVENT_ALL_V1  0xFFFF // ZMQ_EVENT_ALL
#define ZMQ_EVENT_ALL_V2 0x1FFFF // ZMQ_EVENT_ALL_V1 | ZMQ_EVENT_PIPES_STATS
