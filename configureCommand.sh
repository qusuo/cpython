...
export PATH=/Users/holzschu/src/Xcode_iPad/cpython/bin:$PATH
env CC=clang CXX=clang++ \
	...
	PLATFORM=iphoneos \
	./configure --prefix=/Users/holzschu/src/Xcode_iPad/cpython/install_iphoneos --enable-shared \
	--host arm-apple-darwin --build x86_64-apple-darwin --enable-ipv6 \
	--with-openssl=/Users/holzschu/src/Xcode_iPad/cpython/Frameworks_iphoneos \
	with_system_ffi=yes \
...
cp -r ../Python-aux/libffi.xcframework/ios-arm64/Headers/* Frameworks_iphoneos/include/ffi/
cp -r ../Python-aux/crypto.xcframework/ios-arm64/Headers/* Frameworks_iphoneos/include/crypto/
cp -r ../Python-aux/openssl.xcframework/ios-arm64/Headers/* Frameworks_iphoneos/include/openssl/
