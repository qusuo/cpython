...
// Adapted from jQuery UI Touch Punch 0.2.3
var touchHandled = false;
// end adapted from jQuery UI Touch Punch 0.2.3
...
return $.widget( "ui.mouse", {
	...
	_mouseInit: function() {
		...
		this.element
			...
			.on( "touchmove." + this.widgetName, function( event ) {
				return that._touchMove( event );
			} )
			.on( "touchend." + this.widgetName, function( event ) {
				return that._touchEnd( event );
			} )
		    // end adapted from jQuery UI Touch Punch 0.2.3
