...
# Pillow (and other 2 levels libraries):
for library in PIL/_imagingmath PIL/_imagingft PIL/_imagingtk PIL/_imagingmorph PIL/_imaging
do
	level1=`/usr/bin/dirname $library`
	level2=`/usr/bin/basename $library`
	name=$level1.$level2
