...
# Pillow, matplotlib, lxml, astropy (more than 2 levels of hierarchy, suffix is .cpython-39-darwin.so)
...
then
	...
	# create the scipy and scikit-learn modules: 
