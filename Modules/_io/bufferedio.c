...
#if TARGET_OS_IPHONE
void reset_PyBufferedIOBase_Type() {
	PyBufferedIOBase_Type.tp_name = "_io._BufferedIOBase";      /*tp_name*/
	PyBufferedIOBase_Type.tp_basicsize = 0;                          /*tp_basicsize*/
	PyBufferedIOBase_Type.tp_itemsize = 0;                          /*tp_itemsize*/
	PyBufferedIOBase_Type.tp_dealloc = 0;                          /*tp_dealloc*/
	PyBufferedIOBase_Type.tp_vectorcall_offset = 0;                          /*tp_vectorcall_offset*/
	PyBufferedIOBase_Type.tp_getattr = 0;                          /*tp_getattr*/
	PyBufferedIOBase_Type.tp_setattr = 0;                          /*tp_setattr*/
	PyBufferedIOBase_Type.tp_as_async = 0;                          /*tp_as_async*/
	PyBufferedIOBase_Type.tp_repr = 0;                          /*tp_repr*/
	PyBufferedIOBase_Type.tp_as_number = 0;                          /*tp_as_number*/
	PyBufferedIOBase_Type.tp_as_sequence = 0;                          /*tp_as_sequence*/
	PyBufferedIOBase_Type.tp_as_mapping = 0;                          /*tp_as_mapping*/
	PyBufferedIOBase_Type.tp_hash  = 0;                          /*tp_hash */
	PyBufferedIOBase_Type.tp_call = 0;                          /*tp_call*/
	PyBufferedIOBase_Type.tp_str = 0;                          /*tp_str*/
	PyBufferedIOBase_Type.tp_getattro = 0;                          /*tp_getattro*/
	PyBufferedIOBase_Type.tp_setattro = 0;                          /*tp_setattro*/
	PyBufferedIOBase_Type.tp_as_buffer = 0;                          /*tp_as_buffer*/
	PyBufferedIOBase_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;  /*tp_flags*/
	PyBufferedIOBase_Type.tp_doc  = bufferediobase_doc;         /* tp_doc */
	PyBufferedIOBase_Type.tp_traverse  = 0;                          /* tp_traverse */
	PyBufferedIOBase_Type.tp_clear  = 0;                          /* tp_clear */
	PyBufferedIOBase_Type.tp_richcompare  = 0;                          /* tp_richcompare */
	PyBufferedIOBase_Type.tp_weaklistoffset  = 0;                          /* tp_weaklistoffset */
	PyBufferedIOBase_Type.tp_iter  = 0;                          /* tp_iter */
	PyBufferedIOBase_Type.tp_iternext  = 0;                          /* tp_iternext */
	PyBufferedIOBase_Type.tp_methods  = bufferediobase_methods;     /* tp_methods */
	PyBufferedIOBase_Type.tp_members  = 0;                          /* tp_members */
	PyBufferedIOBase_Type.tp_getset  = 0;                          /* tp_getset */
	PyBufferedIOBase_Type.tp_base  = &PyIOBase_Type;             /* tp_base */
	PyBufferedIOBase_Type.tp_dict  = 0;                          /* tp_dict */
	PyBufferedIOBase_Type.tp_descr_get  = 0;                          /* tp_descr_get */
	PyBufferedIOBase_Type.tp_descr_set  = 0;                          /* tp_descr_set */
	PyBufferedIOBase_Type.tp_dictoffset  = 0;                          /* tp_dictoffset */
	PyBufferedIOBase_Type.tp_init  = 0;                          /* tp_init */
	PyBufferedIOBase_Type.tp_alloc  = 0;                          /* tp_alloc */
	PyBufferedIOBase_Type.tp_new  = 0;                          /* tp_new */
	PyBufferedIOBase_Type.tp_free  = 0;                          /* tp_free */
	PyBufferedIOBase_Type.tp_is_gc  = 0;                          /* tp_is_gc */
	PyBufferedIOBase_Type.tp_bases  = 0;                          /* tp_bases */
	PyBufferedIOBase_Type.tp_mro  = 0;                          /* tp_mro */
	PyBufferedIOBase_Type.tp_cache  = 0;                          /* tp_cache */
	PyBufferedIOBase_Type.tp_subclasses  = 0;                          /* tp_subclasses */
	PyBufferedIOBase_Type.tp_weaklist  = 0;                          /* tp_weaklist */
	PyBufferedIOBase_Type.tp_del  = 0;                          /* tp_del */
	PyBufferedIOBase_Type.tp_version_tag  = 0;                          /* tp_version_tag */
	PyBufferedIOBase_Type.tp_finalize  = 0;                          /* tp_finalize */
}
void reset_PyBufferedReader_Type() {
 PyBufferedReader_Type.tp_name = "_io.BufferedReader";       /*tp_name*/
 PyBufferedReader_Type.tp_basicsize = sizeof(buffered);           /*tp_basicsize*/
 PyBufferedReader_Type.tp_itemsize = 0;                          /*tp_itemsize*/
 PyBufferedReader_Type.tp_dealloc = (destructor)buffered_dealloc;     /*tp_dealloc*/
 PyBufferedReader_Type.tp_vectorcall_offset = 0;                          /*tp_vectorcall_offset*/
 PyBufferedReader_Type.tp_getattr = 0;                          /*tp_getattr*/
 PyBufferedReader_Type.tp_setattr = 0;                          /*tp_setattr*/
 PyBufferedReader_Type.tp_as_async = 0;                          /*tp_as_async*/
 PyBufferedReader_Type.tp_repr = (reprfunc)buffered_repr;    /*tp_repr*/
 PyBufferedReader_Type.tp_as_number = 0;                          /*tp_as_number*/
 PyBufferedReader_Type.tp_as_sequence = 0;                          /*tp_as_sequence*/
 PyBufferedReader_Type.tp_as_mapping = 0;                          /*tp_as_mapping*/
 PyBufferedReader_Type.tp_hash  = 0;                          /*tp_hash */
 PyBufferedReader_Type.tp_call = 0;                          /*tp_call*/
 PyBufferedReader_Type.tp_str = 0;                          /*tp_str*/
 PyBufferedReader_Type.tp_getattro = 0;                          /*tp_getattro*/
 PyBufferedReader_Type.tp_setattro = 0;                          /*tp_setattro*/
 PyBufferedReader_Type.tp_as_buffer = 0;                          /*tp_as_buffer*/
 PyBufferedReader_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC;   /*tp_flags*/
 PyBufferedReader_Type.tp_doc  = _io_BufferedReader___init____doc__; /* tp_doc */
 PyBufferedReader_Type.tp_traverse  = (traverseproc)buffered_traverse; /* tp_traverse */
 PyBufferedReader_Type.tp_clear  = (inquiry)buffered_clear;    /* tp_clear */
 PyBufferedReader_Type.tp_richcompare  = 0;                          /* tp_richcompare */
 PyBufferedReader_Type.tp_weaklistoffset = offsetof(buffered, weakreflist); /*tp_weaklistoffset*/
 PyBufferedReader_Type.tp_iter  = 0;                          /* tp_iter */
 PyBufferedReader_Type.tp_iternext  = (iternextfunc)buffered_iternext; /* tp_iternext */
 PyBufferedReader_Type.tp_methods  = bufferedreader_methods;     /* tp_methods */
 PyBufferedReader_Type.tp_members  = bufferedreader_members;     /* tp_members */
 PyBufferedReader_Type.tp_getset  = bufferedreader_getset;      /* tp_getset */
 PyBufferedReader_Type.tp_base  = 0;                          /* tp_base */
 PyBufferedReader_Type.tp_dict  = 0;                          /* tp_dict */
 PyBufferedReader_Type.tp_descr_get  = 0;                          /* tp_descr_get */
 PyBufferedReader_Type.tp_descr_set  = 0;                          /* tp_descr_set */
 PyBufferedReader_Type.tp_dictoffset  = offsetof(buffered, dict); /* tp_dictoffset */
 PyBufferedReader_Type.tp_init  = _io_BufferedReader___init__; /* tp_init */
 PyBufferedReader_Type.tp_alloc  = 0;                          /* tp_alloc */
 PyBufferedReader_Type.tp_new  = PyType_GenericNew;          /* tp_new */
 PyBufferedReader_Type.tp_free  = 0;                          /* tp_free */
 PyBufferedReader_Type.tp_is_gc  = 0;                          /* tp_is_gc */
 PyBufferedReader_Type.tp_bases  = 0;                          /* tp_bases */
 PyBufferedReader_Type.tp_mro  = 0;                          /* tp_mro */
 PyBufferedReader_Type.tp_cache  = 0;                          /* tp_cache */
 PyBufferedReader_Type.tp_subclasses  = 0;                          /* tp_subclasses */
 PyBufferedReader_Type.tp_weaklist  = 0;                          /* tp_weaklist */
 PyBufferedReader_Type.tp_del  = 0;                          /* tp_del */
 PyBufferedReader_Type.tp_version_tag  = 0;                          /* tp_version_tag */
 PyBufferedReader_Type.tp_finalize  = 0;                          /* tp_finalize */
}
void reset_PyBufferedWriter_Type() {
	PyBufferedWriter_Type.tp_name = "_io.BufferedWriter";       /*tp_name*/
	PyBufferedWriter_Type.tp_basicsize = sizeof(buffered);           /*tp_basicsize*/
	PyBufferedWriter_Type.tp_itemsize = 0;                          /*tp_itemsize*/
	PyBufferedWriter_Type.tp_dealloc = (destructor)buffered_dealloc;     /*tp_dealloc*/
	PyBufferedWriter_Type.tp_vectorcall_offset = 0;                          /*tp_vectorcall_offset*/
	PyBufferedWriter_Type.tp_getattr = 0;                          /*tp_getattr*/
	PyBufferedWriter_Type.tp_setattr = 0;                          /*tp_setattr*/
	PyBufferedWriter_Type.tp_as_async = 0;                          /*tp_as_async*/
	PyBufferedWriter_Type.tp_repr = (reprfunc)buffered_repr;    /*tp_repr*/
	PyBufferedWriter_Type.tp_as_number = 0;                          /*tp_as_number*/
	PyBufferedWriter_Type.tp_as_sequence = 0;                          /*tp_as_sequence*/
	PyBufferedWriter_Type.tp_as_mapping = 0;                          /*tp_as_mapping*/
	PyBufferedWriter_Type.tp_hash  = 0;                          /*tp_hash */
	PyBufferedWriter_Type.tp_call = 0;                          /*tp_call*/
	PyBufferedWriter_Type.tp_str = 0;                          /*tp_str*/
	PyBufferedWriter_Type.tp_getattro = 0;                          /*tp_getattro*/
	PyBufferedWriter_Type.tp_setattro = 0;                          /*tp_setattro*/
	PyBufferedWriter_Type.tp_as_buffer = 0;                          /*tp_as_buffer*/
	PyBufferedWriter_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC;   /*tp_flags */ 
	PyBufferedWriter_Type.tp_doc  = _io_BufferedWriter___init____doc__; /* tp_doc */
	PyBufferedWriter_Type.tp_traverse  = (traverseproc)buffered_traverse; /* tp_traverse */
	PyBufferedWriter_Type.tp_clear  = (inquiry)buffered_clear;    /* tp_clear */
	PyBufferedWriter_Type.tp_richcompare  = 0;                          /* tp_richcompare */
	PyBufferedWriter_Type.tp_weaklistoffset = offsetof(buffered, weakreflist); /*tp_weaklistoffset*/
	PyBufferedWriter_Type.tp_iter  = 0;                          /* tp_iter */
	PyBufferedWriter_Type.tp_iternext  = 0;                          /* tp_iternext */
	PyBufferedWriter_Type.tp_methods  = bufferedwriter_methods;     /* tp_methods */
	PyBufferedWriter_Type.tp_members  = bufferedwriter_members;     /* tp_members */
	PyBufferedWriter_Type.tp_getset  = bufferedwriter_getset;      /* tp_getset */
	PyBufferedWriter_Type.tp_base  = 0;                          /* tp_base */
	PyBufferedWriter_Type.tp_dict  = 0;                          /* tp_dict */
	PyBufferedWriter_Type.tp_descr_get  = 0;                          /* tp_descr_get */
	PyBufferedWriter_Type.tp_descr_set  = 0;                          /* tp_descr_set */
	PyBufferedWriter_Type.tp_dictoffset  = offsetof(buffered, dict);   /* tp_dictoffset */
	PyBufferedWriter_Type.tp_init  = _io_BufferedWriter___init__; /* tp_init */
	PyBufferedWriter_Type.tp_alloc  = 0;                          /* tp_alloc */
	PyBufferedWriter_Type.tp_new  = PyType_GenericNew;          /* tp_new */
	PyBufferedWriter_Type.tp_free  = 0;                          /* tp_free */
	PyBufferedWriter_Type.tp_is_gc  = 0;                          /* tp_is_gc */
	PyBufferedWriter_Type.tp_bases  = 0;                          /* tp_bases */
	PyBufferedWriter_Type.tp_mro  = 0;                          /* tp_mro */
	PyBufferedWriter_Type.tp_cache  = 0;                          /* tp_cache */
	PyBufferedWriter_Type.tp_subclasses  = 0;                          /* tp_subclasses */
	PyBufferedWriter_Type.tp_weaklist  = 0;                          /* tp_weaklist */
	PyBufferedWriter_Type.tp_del  = 0;                          /* tp_del */
	PyBufferedWriter_Type.tp_version_tag  = 0;                          /* tp_version_tag */
	PyBufferedWriter_Type.tp_finalize  = 0;                          /* tp_finalize */
}
void reset_PyBufferedRWPair_Type() {
	PyBufferedRWPair_Type.tp_name = "_io.BufferedRWPair";       /*tp_name*/
	PyBufferedRWPair_Type.tp_basicsize = sizeof(rwpair);             /*tp_basicsize*/
	PyBufferedRWPair_Type.tp_itemsize = 0;                          /*tp_itemsize*/
	PyBufferedRWPair_Type.tp_dealloc = (destructor)bufferedrwpair_dealloc;     /*tp_dealloc*/
	PyBufferedRWPair_Type.tp_vectorcall_offset = 0;                          /*tp_vectorcall_offset*/
	PyBufferedRWPair_Type.tp_getattr = 0;                          /*tp_getattr*/
	PyBufferedRWPair_Type.tp_setattr = 0;                          /*tp_setattr*/
	PyBufferedRWPair_Type.tp_as_async = 0;                          /*tp_as_async*/
	PyBufferedRWPair_Type.tp_repr = 0;                          /*tp_repr*/
	PyBufferedRWPair_Type.tp_as_number = 0;                          /*tp_as_number*/
	PyBufferedRWPair_Type.tp_as_sequence = 0;                          /*tp_as_sequence*/
	PyBufferedRWPair_Type.tp_as_mapping = 0;                          /*tp_as_mapping*/
	PyBufferedRWPair_Type.tp_hash  = 0;                          /*tp_hash */
	PyBufferedRWPair_Type.tp_call = 0;                          /*tp_call*/
	PyBufferedRWPair_Type.tp_str = 0;                          /*tp_str*/
	PyBufferedRWPair_Type.tp_getattro = 0;                          /*tp_getattro*/
	PyBufferedRWPair_Type.tp_setattro = 0;                          /*tp_setattro*/
	PyBufferedRWPair_Type.tp_as_buffer = 0;                          /*tp_as_buffer*/
	PyBufferedRWPair_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC;   /* tp_flags */
	PyBufferedRWPair_Type.tp_doc  = _io_BufferedRWPair___init____doc__; /* tp_doc */
	PyBufferedRWPair_Type.tp_traverse  = (traverseproc)bufferedrwpair_traverse; /* tp_traverse */
	PyBufferedRWPair_Type.tp_clear  = (inquiry)bufferedrwpair_clear; /* tp_clear */
	PyBufferedRWPair_Type.tp_richcompare  = 0;                          /* tp_richcompare */
	PyBufferedRWPair_Type.tp_weaklistoffset = offsetof(rwpair, weakreflist); /*tp_weaklistoffset*/
	PyBufferedRWPair_Type.tp_iter  = 0;                          /* tp_iter */
	PyBufferedRWPair_Type.tp_iternext  = 0;                          /* tp_iternext */
	PyBufferedRWPair_Type.tp_methods  = bufferedrwpair_methods;     /* tp_methods */
	PyBufferedRWPair_Type.tp_members  = 0;                          /* tp_members */
	PyBufferedRWPair_Type.tp_getset  = bufferedrwpair_getset;      /* tp_getset */
	PyBufferedRWPair_Type.tp_base  = 0;                          /* tp_base */
	PyBufferedRWPair_Type.tp_dict  = 0;                          /* tp_dict */
	PyBufferedRWPair_Type.tp_descr_get  = 0;                          /* tp_descr_get */
	PyBufferedRWPair_Type.tp_descr_set  = 0;                          /* tp_descr_set */
	PyBufferedRWPair_Type.tp_dictoffset  = offsetof(rwpair, dict);     /* tp_dictoffset */
	PyBufferedRWPair_Type.tp_init  = _io_BufferedRWPair___init__; /* tp_init */
	PyBufferedRWPair_Type.tp_alloc  = 0;                          /* tp_alloc */
	PyBufferedRWPair_Type.tp_new  = PyType_GenericNew;          /* tp_new */
	PyBufferedRWPair_Type.tp_free  = 0;                          /* tp_free */
	PyBufferedRWPair_Type.tp_is_gc  = 0;                          /* tp_is_gc */
	PyBufferedRWPair_Type.tp_bases  = 0;                          /* tp_bases */
	PyBufferedRWPair_Type.tp_mro  = 0;                          /* tp_mro */
	PyBufferedRWPair_Type.tp_cache  = 0;                          /* tp_cache */
	PyBufferedRWPair_Type.tp_subclasses  = 0;                          /* tp_subclasses */
	PyBufferedRWPair_Type.tp_weaklist  = 0;                          /* tp_weaklist */
	PyBufferedRWPair_Type.tp_del  = 0;                          /* tp_del */
	PyBufferedRWPair_Type.tp_version_tag  = 0;                          /* tp_version_tag */
	PyBufferedRWPair_Type.tp_finalize  = 0;                          /* tp_finalize */
}
void reset_PyBufferedRandom_Type() {
	PyBufferedRandom_Type.tp_name= "_io.BufferedRandom";              /* tp_name*/
	PyBufferedRandom_Type.tp_basicsize= sizeof(buffered);                  /* tp_basicsize*/
	PyBufferedRandom_Type.tp_itemsize= 0;                                 /* tp_itemsize*/
	PyBufferedRandom_Type.tp_dealloc= (destructor)buffered_dealloc;      /* tp_dealloc*/
	PyBufferedRandom_Type.tp_vectorcall_offset= 0;                                 /* tp_vectorcall_offset*/
	PyBufferedRandom_Type.tp_getattr= 0;                                 /* tp_getattr*/
	PyBufferedRandom_Type.tp_setattr= 0;                                 /* tp_setattr*/
	PyBufferedRandom_Type.tp_as_async= 0;                                 /* tp_as_async*/
	PyBufferedRandom_Type.tp_repr= (reprfunc)buffered_repr;           /* tp_repr*/
	PyBufferedRandom_Type.tp_as_number= 0;                                 /* tp_as_number*/
	PyBufferedRandom_Type.tp_as_sequence= 0;                                 /* tp_as_sequence*/
	PyBufferedRandom_Type.tp_as_mapping= 0;                                 /* tp_as_mapping*/
	PyBufferedRandom_Type.tp_hash = 0;                                 /* tp_hash */
	PyBufferedRandom_Type.tp_call= 0;                                 /* tp_call*/
	PyBufferedRandom_Type.tp_str= 0;                                 /* tp_str*/
	PyBufferedRandom_Type.tp_getattro= 0;                                 /* tp_getattro*/
	PyBufferedRandom_Type.tp_setattro= 0;                                 /* tp_setattro*/
	PyBufferedRandom_Type.tp_as_buffer= 0;                                 /* tp_as_buffer*/
	PyBufferedRandom_Type.tp_flags= Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC;   /*tp_flags*/
	PyBufferedRandom_Type.tp_doc = _io_BufferedRandom___init____doc__;/* tp_doc */
	PyBufferedRandom_Type.tp_traverse = (traverseproc)buffered_traverse;   /* tp_traverse */
	PyBufferedRandom_Type.tp_clear = (inquiry)buffered_clear;           /* tp_clear */
	PyBufferedRandom_Type.tp_richcompare = 0;                                 /* tp_richcompare */
	PyBufferedRandom_Type.tp_weaklistoffset= offsetof(buffered, weakreflist);   /* tp_weaklistoffset*/
	PyBufferedRandom_Type.tp_iter = 0;                                 /* tp_iter */
	PyBufferedRandom_Type.tp_iternext = (iternextfunc)buffered_iternext;   /* tp_iternext */
	PyBufferedRandom_Type.tp_methods = bufferedrandom_methods;            /* tp_methods */
	PyBufferedRandom_Type.tp_members = bufferedrandom_members;            /* tp_members */
	PyBufferedRandom_Type.tp_getset = bufferedrandom_getset;             /* tp_getset */
	PyBufferedRandom_Type.tp_base = 0;                                 /* tp_base */
	PyBufferedRandom_Type.tp_dict= 0;                                 /* tp_dict*/
	PyBufferedRandom_Type.tp_descr_get = 0;                                 /* tp_descr_get */
	PyBufferedRandom_Type.tp_descr_set = 0;                                 /* tp_descr_set */
	PyBufferedRandom_Type.tp_dictoffset= offsetof(buffered, dict);          /* tp_dictoffset*/
	PyBufferedRandom_Type.tp_init = _io_BufferedRandom___init__;       /* tp_init */
	PyBufferedRandom_Type.tp_alloc = 0;                                 /* tp_alloc */
	PyBufferedRandom_Type.tp_new = PyType_GenericNew;                 /* tp_new */
	PyBufferedRandom_Type.tp_free = 0;                                 /* tp_free */
	PyBufferedRandom_Type.tp_is_gc = 0;                                 /* tp_is_gc */
	PyBufferedRandom_Type.tp_bases = 0;                                 /* tp_bases */
	PyBufferedRandom_Type.tp_mro = 0;                                 /* tp_mro */
	PyBufferedRandom_Type.tp_cache = 0;                                 /* tp_cache */
	PyBufferedRandom_Type.tp_subclasses = 0;                                 /* tp_subclasses */
	PyBufferedRandom_Type.tp_weaklist = 0;                                 /* tp_weaklist */
	PyBufferedRandom_Type.tp_del = 0;                                 /* tp_del */
	PyBufferedRandom_Type.tp_version_tag = 0;                                 /* tp_version_tag */
	PyBufferedRandom_Type.tp_finalize = 0;                                 /* tp_finalize */
}
#endif
