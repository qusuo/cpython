...
#if TARGET_OS_IPHONE
void reset_PyTextIOBase_Type() {
	PyTextIOBase_Type.tp_name= "_io._TextIOBase";          /* tp_name*/
	PyTextIOBase_Type.tp_basicsize= 0;                          /* tp_basicsize*/
	PyTextIOBase_Type.tp_itemsize= 0;                          /* tp_itemsize*/
	PyTextIOBase_Type.tp_dealloc= 0;                          /* tp_dealloc*/
	PyTextIOBase_Type.tp_vectorcall_offset= 0;                          /* tp_vectorcall_offset*/
	PyTextIOBase_Type.tp_getattr= 0;                          /* tp_getattr*/
	PyTextIOBase_Type.tp_setattr= 0;                          /* tp_setattr*/
	PyTextIOBase_Type.tp_as_async= 0;                          /* tp_as_async*/
	PyTextIOBase_Type.tp_repr= 0;                          /* tp_repr*/
	PyTextIOBase_Type.tp_as_number= 0;                          /* tp_as_number*/
	PyTextIOBase_Type.tp_as_sequence= 0;                          /* tp_as_sequence*/
	PyTextIOBase_Type.tp_as_mapping= 0;                          /* tp_as_mapping*/
	PyTextIOBase_Type.tp_hash = 0;                          /* tp_hash */
	PyTextIOBase_Type.tp_call= 0;                          /* tp_call*/
	PyTextIOBase_Type.tp_str= 0;                          /* tp_str*/
	PyTextIOBase_Type.tp_getattro= 0;                          /* tp_getattro*/
	PyTextIOBase_Type.tp_setattro= 0;                          /* tp_setattro*/
	PyTextIOBase_Type.tp_as_buffer= 0;                          /* tp_as_buffer*/
	PyTextIOBase_Type.tp_flags= Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;  /*tp_flags*/
	PyTextIOBase_Type.tp_doc = textiobase_doc;             /* tp_doc */
	PyTextIOBase_Type.tp_traverse = 0;                          /* tp_traverse */
	PyTextIOBase_Type.tp_clear = 0;                          /* tp_clear */
	PyTextIOBase_Type.tp_richcompare = 0;                          /* tp_richcompare */
	PyTextIOBase_Type.tp_weaklistoffset = 0;                          /* tp_weaklistoffset */
	PyTextIOBase_Type.tp_iter = 0;                          /* tp_iter */
	PyTextIOBase_Type.tp_iternext = 0;                          /* tp_iternext */
	PyTextIOBase_Type.tp_methods = textiobase_methods;         /* tp_methods */
	PyTextIOBase_Type.tp_members = 0;                          /* tp_members */
	PyTextIOBase_Type.tp_getset = textiobase_getset;          /* tp_getset */
	PyTextIOBase_Type.tp_base = &PyIOBase_Type;             /* tp_base */
	PyTextIOBase_Type.tp_dict = 0;                          /* tp_dict */
	PyTextIOBase_Type.tp_descr_get = 0;                          /* tp_descr_get */
	PyTextIOBase_Type.tp_descr_set = 0;                          /* tp_descr_set */
	PyTextIOBase_Type.tp_dictoffset = 0;                          /* tp_dictoffset */
	PyTextIOBase_Type.tp_init = 0;                          /* tp_init */
	PyTextIOBase_Type.tp_alloc = 0;                          /* tp_alloc */
	PyTextIOBase_Type.tp_new = 0;                          /* tp_new */
	PyTextIOBase_Type.tp_free = 0;                          /* tp_free */
	PyTextIOBase_Type.tp_is_gc = 0;                          /* tp_is_gc */
	PyTextIOBase_Type.tp_bases = 0;                          /* tp_bases */
	PyTextIOBase_Type.tp_mro = 0;                          /* tp_mro */
	PyTextIOBase_Type.tp_cache = 0;                          /* tp_cache */
	PyTextIOBase_Type.tp_subclasses = 0;                          /* tp_subclasses */
	PyTextIOBase_Type.tp_weaklist = 0;                          /* tp_weaklist */
	PyTextIOBase_Type.tp_del = 0;                          /* tp_del */
	PyTextIOBase_Type.tp_version_tag = 0;                          /* tp_version_tag */
	PyTextIOBase_Type.tp_finalize = 0;                          /* tp_finalize */
}
void reset_PyIncrementalNewlineDecoder_Type() {
	PyIncrementalNewlineDecoder_Type.tp_name=  "_io.IncrementalNewlineDecoder"; /*tp_name*/
	PyIncrementalNewlineDecoder_Type.tp_basicsize=  sizeof(nldecoder_object);        /*tp_basicsize*/
	PyIncrementalNewlineDecoder_Type.tp_itemsize=  0;                               /*tp_itemsize*/
	PyIncrementalNewlineDecoder_Type.tp_dealloc=  (destructor)incrementalnewlinedecoder_dealloc; /*tp_dealloc*/
	PyIncrementalNewlineDecoder_Type.tp_vectorcall_offset=  0;               /*tp_vectorcall_offset*/
	PyIncrementalNewlineDecoder_Type.tp_getattr=  0;                               /*tp_getattr*/
	PyIncrementalNewlineDecoder_Type.tp_setattr=  0;                               /*tp_setattr*/
	PyIncrementalNewlineDecoder_Type.tp_as_async=  0;                               /*tp_as_async*/
	PyIncrementalNewlineDecoder_Type.tp_repr=  0;                               /*tp_repr*/
	PyIncrementalNewlineDecoder_Type.tp_as_number=  0;                               /*tp_as_number*/
	PyIncrementalNewlineDecoder_Type.tp_as_sequence=  0;                               /*tp_as_sequence*/
	PyIncrementalNewlineDecoder_Type.tp_as_mapping=  0;                               /*tp_as_mapping*/
	PyIncrementalNewlineDecoder_Type.tp_hash =  0;                               /*tp_hash */
	PyIncrementalNewlineDecoder_Type.tp_call=  0;                               /*tp_call*/
	PyIncrementalNewlineDecoder_Type.tp_str=  0;                               /*tp_str*/
	PyIncrementalNewlineDecoder_Type.tp_getattro=  0;                               /*tp_getattro*/
	PyIncrementalNewlineDecoder_Type.tp_setattro=  0;                               /*tp_setattro*/
	PyIncrementalNewlineDecoder_Type.tp_as_buffer=  0;                               /*tp_as_buffer*/
	PyIncrementalNewlineDecoder_Type.tp_flags=  Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;  /*tp_flags*/
	PyIncrementalNewlineDecoder_Type.tp_doc =  _io_IncrementalNewlineDecoder___init____doc__; /* tp_doc */
	PyIncrementalNewlineDecoder_Type.tp_traverse =  0;                               /* tp_traverse */
	PyIncrementalNewlineDecoder_Type.tp_clear =  0;                               /* tp_clear */
	PyIncrementalNewlineDecoder_Type.tp_richcompare =  0;                               /* tp_richcompare */
	PyIncrementalNewlineDecoder_Type.tp_weaklistoffset=  0;                               /*tp_weaklistoffset*/
	PyIncrementalNewlineDecoder_Type.tp_iter =  0;                               /* tp_iter */
	PyIncrementalNewlineDecoder_Type.tp_iternext =  0;                               /* tp_iternext */
	PyIncrementalNewlineDecoder_Type.tp_methods =  incrementalnewlinedecoder_methods; /* tp_methods */
	PyIncrementalNewlineDecoder_Type.tp_members =  0;                               /* tp_members */
	PyIncrementalNewlineDecoder_Type.tp_getset =  incrementalnewlinedecoder_getset; /* tp_getset */
	PyIncrementalNewlineDecoder_Type.tp_base =  0;                               /* tp_base */
	PyIncrementalNewlineDecoder_Type.tp_dict =  0;                               /* tp_dict */
	PyIncrementalNewlineDecoder_Type.tp_descr_get =  0;                               /* tp_descr_get */
	PyIncrementalNewlineDecoder_Type.tp_descr_set =  0;                               /* tp_descr_set */
	PyIncrementalNewlineDecoder_Type.tp_dictoffset =  0;                               /* tp_dictoffset */
	PyIncrementalNewlineDecoder_Type.tp_init =  _io_IncrementalNewlineDecoder___init__; /* tp_init */
	PyIncrementalNewlineDecoder_Type.tp_alloc =  0;                               /* tp_alloc */
	PyIncrementalNewlineDecoder_Type.tp_new =  PyType_GenericNew;               /* tp_new */
}
void reset_PyTextIOWrapper_Type() {
	PyTextIOWrapper_Type.tp_name= "_io.TextIOWrapper";        /* tp_name*/
	PyTextIOWrapper_Type.tp_basicsize= sizeof(textio);             /* tp_basicsize*/
	PyTextIOWrapper_Type.tp_itemsize= 0;                          /* tp_itemsize*/
	PyTextIOWrapper_Type.tp_dealloc= (destructor)textiowrapper_dealloc; /*tp_dealloc*/
	PyTextIOWrapper_Type.tp_vectorcall_offset= 0;                          /* tp_vectorcall_offset*/
	PyTextIOWrapper_Type.tp_getattr= 0;                          /* tp_getattr*/
	PyTextIOWrapper_Type.tp_setattr= 0;                          /* tp_setattr*/
	PyTextIOWrapper_Type.tp_as_async= 0;                          /* tp_as_async*/
	PyTextIOWrapper_Type.tp_repr= (reprfunc)textiowrapper_repr;/* tp_repr*/
	PyTextIOWrapper_Type.tp_as_number= 0;                          /* tp_as_number*/
	PyTextIOWrapper_Type.tp_as_sequence= 0;                          /* tp_as_sequence*/
	PyTextIOWrapper_Type.tp_as_mapping= 0;                          /* tp_as_mapping*/
	PyTextIOWrapper_Type.tp_hash = 0;                          /* tp_hash */
	PyTextIOWrapper_Type.tp_call= 0;                          /* tp_call*/
	PyTextIOWrapper_Type.tp_str= 0;                          /* tp_str*/
	PyTextIOWrapper_Type.tp_getattro= 0;                          /* tp_getattro*/
	PyTextIOWrapper_Type.tp_setattro= 0;                          /* tp_setattro*/
	PyTextIOWrapper_Type.tp_as_buffer= 0;                          /* tp_as_buffer*/
	PyTextIOWrapper_Type.tp_flags= Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE | Py_TPFLAGS_HAVE_GC;   /*tp_flags*/
	PyTextIOWrapper_Type.tp_doc = _io_TextIOWrapper___init____doc__; /* tp_doc */
	PyTextIOWrapper_Type.tp_traverse = (traverseproc)textiowrapper_traverse; /* tp_traverse */
	PyTextIOWrapper_Type.tp_clear = (inquiry)textiowrapper_clear; /* tp_clear */
	PyTextIOWrapper_Type.tp_richcompare = 0;                          /* tp_richcompare */
	PyTextIOWrapper_Type.tp_weaklistoffset= offsetof(textio, weakreflist); /*tp_weaklistoffset*/
	PyTextIOWrapper_Type.tp_iter = 0;                          /* tp_iter */
	PyTextIOWrapper_Type.tp_iternext = (iternextfunc)textiowrapper_iternext; /* tp_iternext */
	PyTextIOWrapper_Type.tp_methods = textiowrapper_methods;      /* tp_methods */
	PyTextIOWrapper_Type.tp_members = textiowrapper_members;      /* tp_members */
	PyTextIOWrapper_Type.tp_getset = textiowrapper_getset;       /* tp_getset */
	PyTextIOWrapper_Type.tp_base = 0;                          /* tp_base */
	PyTextIOWrapper_Type.tp_dict = 0;                          /* tp_dict */
	PyTextIOWrapper_Type.tp_descr_get = 0;                          /* tp_descr_get */
	PyTextIOWrapper_Type.tp_descr_set = 0;                          /* tp_descr_set */
	PyTextIOWrapper_Type.tp_dictoffset= offsetof(textio, dict);     /*tp_dictoffset*/
	PyTextIOWrapper_Type.tp_init = _io_TextIOWrapper___init__; /* tp_init */
	PyTextIOWrapper_Type.tp_alloc = 0;                          /* tp_alloc */
	PyTextIOWrapper_Type.tp_new = PyType_GenericNew;          /* tp_new */
	PyTextIOWrapper_Type.tp_free = 0;                          /* tp_free */
	PyTextIOWrapper_Type.tp_is_gc = 0;                          /* tp_is_gc */
	PyTextIOWrapper_Type.tp_bases = 0;                          /* tp_bases */
	PyTextIOWrapper_Type.tp_mro = 0;                          /* tp_mro */
	PyTextIOWrapper_Type.tp_cache = 0;                          /* tp_cache */
	PyTextIOWrapper_Type.tp_subclasses = 0;                          /* tp_subclasses */
	PyTextIOWrapper_Type.tp_weaklist = 0;                          /* tp_weaklist */
	PyTextIOWrapper_Type.tp_del = 0;                          /* tp_del */
	PyTextIOWrapper_Type.tp_version_tag = 0;                          /* tp_version_tag */
	PyTextIOWrapper_Type.tp_finalize = 0;                          /* tp_finalize */
}
#endif
