...
static void init_DictRemover_Type() {
    ...
    DictRemover_Type.tp_doc = PyDoc_STR("deletes a key from a dictionary");          /* tp_doc */
...
static void init_PyCStructType_Type() {
    ...
    PyCStructType_Type.tp_doc = PyDoc_STR("metatype for the CData Objects");           /* tp_doc */
...
static void init_UnionType_Type() {
   ...
   UnionType_Type.tp_doc = PyDoc_STR("metatype for the CData Objects");           /* tp_doc */
...
static void init_PyCPointerType_Type() {
    ...
    PyCPointerType_Type.tp_doc = PyDoc_STR("metatype for the Pointer Objects");         /* tp_doc */
...
static void init_PyCArrayType_Type() {
    ...
    PyCArrayType_Type.tp_doc = PyDoc_STR("metatype for the Array Objects");           /* tp_doc */
...
static void init_PyCSimpleType_Type() {
    ...
    PyCSimpleType_Type.tp_doc = PyDoc_STR("metatype for the PyCSimpleType Objects");   /* tp_doc */
...
static void init_PyCFuncPtrType_Type() {
    ...
    PyCFuncPtrType_Type.tp_doc = PyDoc_STR("metatype for C function pointers");         /* tp_doc */
...
static void init_PyCData_Type() {
    ...
    PyCData_Type.tp_doc = PyDoc_STR("XXX to be provided");                       /* tp_doc */
...
static void init_PyCFuncPtr_Type() {
    ...
    PyCFuncPtr_Type.tp_doc = PyDoc_STR("Function Pointer");                         /* tp_doc */
...
static void init_Struct_Type() {
    ...
    Struct_Type.tp_doc = PyDoc_STR("Structure base class");                     /* tp_doc */
...
static void init_Union_Type() {
    ...
    Union_Type.tp_doc = PyDoc_STR("Union base class");                         /* tp_doc */
...
static void init_PyCArray_Type() {
    ...
    PyCArray_Type.tp_doc = PyDoc_STR("XXX to be provided");                       /* tp_doc */
...
static void init_Simple_Type() {
    ...
    Simple_Type.tp_doc = PyDoc_STR("XXX to be provided");                       /* tp_doc */
...
static void init_PyCPointer_Type() {
    ...
    PyCPointer_Type.tp_doc = PyDoc_STR("XXX to be provided");                       /* tp_doc */
